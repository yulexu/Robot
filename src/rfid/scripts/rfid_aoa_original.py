...
def rfidcallback(data):
	...
	if valid:
		phase_sampled,rssi_sampled = RFID_data.get_data_2A((stop_time + start_time ) /2)
...
if __name__ == '__main__':
	...
	RFID_data = RFID_dataloader_robot('E280-1160-6000-0209-F811-5CD4', num_of_antenna = 2)
	
	try:
		
		rospy.init_node('rfid_aoa', anonymous = True)
		rospy.Subscriber("/", Image, self.imagecallback)
