...
CMyApplication::setImpinjReaderConfig(void)
{
    ...
    ** case suggests we are bandwidth constrained */
    ...
    pROcontent->setEnableFirstSeenTimestamp(true);//set false will disable the timestamp show
    ...
    pROcontent->setEnableTagSeenCount(true);
    ...
    char *                        av[])
{
    ...
    ros::NodeHandle nh;
    this->rfid_publisher = nh.advertise<rfid::rfid_msg>("/rfid_message", 10); // queue_size is initially set to 10, totally 6 antenna
}
