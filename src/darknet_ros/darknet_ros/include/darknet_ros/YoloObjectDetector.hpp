...
#include <darknet_ros_msgs/DetectionPoseList.h>
// Darknet.
#ifdef GPU
#include "cublas_v2.h"
...
class YoloObjectDetector {
 ...
 private:
  ...
  image_transport::ImageTransport depthimageTransport_;
  ...
  darknet_ros_msgs::DetectionPoseList DetectionPoseListResults_;
  //! Camera related parameters.
  int frameWidth_;
  int frameHeight_;
  int depthframeWidth_;
  int depthframeHeight_;
  ...
  std_msgs::Header depthimageHeader_;
  cv::Mat camImageCopy_;
  cv::Mat depthcamImageCopy_;
  boost::shared_mutex mutexImageCallback_;
  boost::shared_mutex mutexDepthImageCallback_;
  bool imageStatus_ = false;
  bool depthimageStatus_ = false;
  boost::shared_mutex mutexImageStatus_;
  boost::shared_mutex mutexDepthImageStatus_;
