...
(defsystem "darknet_ros_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "DetectionPose" :depends-on ("_package_DetectionPose"))
    (:file "_package_DetectionPose" :depends-on ("_package"))
    (:file "DetectionPoseList" :depends-on ("_package_DetectionPoseList"))
    (:file "_package_DetectionPoseList" :depends-on ("_package"))
