...
QT_INIT_METAOBJECT const QMetaObject main_window::MainWindow::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_main_window__MainWindow.data,
    qt_meta_data_main_window__MainWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
